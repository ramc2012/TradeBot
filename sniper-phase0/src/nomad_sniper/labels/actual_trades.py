...
This is the Phase 0 primary labeling path: we are not generating synthetic candidates yet,
we are evaluating whether the feature set discriminates winners from losers among the
