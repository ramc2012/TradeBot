...
def _close_outcome(cursor, ticket_id, *, fill_price, exit_price, exit_ts, exit_reason,
    ...
    # R comes from the SHARED definition, not from pnl/risk_rupees. The two
    # agree whenever risk_rupees is the full premium (M7's rule), but deriving
    # it here from whatever happens to be in sizing_risk_rupees made M9's R
